...
class BookingControllerTest {
    ...
    @Test
    void should400IsReturnedWhenAddBookingThrowValidationException() throws Exception {
        when(client.addBooking(anyLong(), any(BookingDto.class)))
    ...
    @Test
    void should404IsReturnedWhenAddBookingThrowValidationException() throws Exception {
        when(client.addBooking(anyLong(), any(BookingDto.class)))
